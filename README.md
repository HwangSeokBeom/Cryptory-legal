...
이 저장소는 순수 HTML/CSS 기반의 단일 정적 사이트로 구성됩니다. GitHub Pages에 그대로 배포하여 개인정보처리방침, 이용약관, 고객지원, 계정 삭제 안내, 투자 유의 및 면책 안내 URL로 사용할 수 있습니다.
...
- 상단 navigation의 Home, Privacy Policy, Terms, Support, Delete Account, Disclaimer 링크가 모두 동작하는지 확인합니다.
